...
$$(document).on('page:init', '.page[data-name="index"]', function (e) {
    ...
    $$('#inGame').on('click', function(){
    	if ($$('#j1').val()=="") {
    		app.dialog.alert('No completaste los nombres');
    	} else if ($$('#j2').val()=="") {
    		app.dialog.alert('No completaste todos los campos');
    	} else {
...
$$('#btnLimpiar').on('click',function(){
	app.dialog.confirm("¿Esta seguro que desea borrar?", function () {
        for (var i=1; i<=11; i++){
    		$$('#j1d'+i).text(0);
    		$$('#j2d'+i).text(0);
  		}
...
//aca se abre el action sheet de juegos
$$('.acjj1').on('click', () => {
        acjj1.open();
});


/*action sheet dados, se crea y se abre*/
...
$$('#btnTerminar').on('click',function(){
  app.dialog.confirm("Puntaje total "+player1+": "+totalj1 +"<br/>Puntaje total "+player2+": "+totalj2, function () {
